	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<th>Computer Name 
				<a class="btn btn-default btn-xs" id="sortDesc"	href="RedirectIndexServlet"><span class="glyphicon glyphicon-sort-by-alphabet"></span></a>
				<a class="btn btn-default btn-xs" id="sortDesc"	href="RedirectIndexServlet"><span class="glyphicon glyphicon-sort"></span></a>
